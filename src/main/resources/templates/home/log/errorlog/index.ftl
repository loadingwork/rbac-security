    ...
    <div  class="g-body">
    	...
    	<!-- crud区域  -->
   		<div class="g-crud g-padding16">
   				<!-- 操作区域 -->
   				<div class="m-options">
   					<button class="layui-btn layui-btn-normal  batch-handle">批量处理</button>
   				</div>
   				<!-- 表格区域 -->
...
layui.use(['element', 'table', 'layer'], function(){
  ...
  table.render({
    ...
    cols: [[
      ...
      {field:'operatingSystem', width:140, title: '操作类型'},
      {field:'browser', width:140, title: '浏览器类型'},
      {field:'clientIpAddress', width:180, title: 'ip地址'},
      {field:'url', width:180, title: '访问地址'},
      {field:'httpMethod', width:80, title: '请求方式'},
