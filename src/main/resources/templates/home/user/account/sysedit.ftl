...
<div  class="g-body">
	...
	<div class="g-main  layui-form">
		...
		<div  class="g-main-hide">
			<input type="hidden"  id="ucode" value="${account.ucode}" />
		</div>
		    ...
		    <div class="layui-inline  m-form-item  f-cb">
		      ...
		      <div class="layui-input-inline">
		      	<#if  sysUser?? >
		      		...
		      		<#else>
		      		<input type="text" id="nickname" name="nickname"  autocomplete="off" class="layui-input"  value="" >
		      	</#if>
		      </div>
		    </div>
		    ...
		    <div class="layui-inline  m-form-item  f-cb">
		      ...
		      <div class="layui-input-inline">
		      	<#if  sysUser??>
		      		...
		      		<#else>
		      		<input type="text" id="telephone" name="telephone"  autocomplete="off" class="layui-input"  value=""  >
		      	</#if>
		      </div>
		    </div>
		    ...
		    <div class="layui-inline  m-form-item  f-cb">
		      ...
		      <div class="layui-input-inline">
		        <#if  sysUser??>
		      		...
		      		<#else>
		      		<input type="number"  id="age" name="age"  autocomplete="off" class="layui-input" value=""  >
		      	</#if>
		      </div>
		    </div>
		    ...
		    <div class="layui-inline   f-cb">
		      ...
		      <div class="layui-input-inline">
		      	<#if  sysUser??>
		      		...
		      		<#else>
		      		<input type="checkbox"  name="locked" id="locked" lay-skin="switch" lay-filter="locked" lay-text="是|否"  />
		      	</#if>
		      </div>
		    </div>
		    ...
		    <div class="layui-inline   f-cb">
		      ...
		      <div class="layui-input-inline">
		      	<#if  sysUser??>
		      		...
		      		<#else>
		      		<input type="checkbox" checked="" name="activated" id="activated" lay-skin="switch" lay-filter="activated" lay-text="是|否"  />
		      	</#if>
		      </div>
		    </div>
		    ...
		    <div class="layui-inline   f-cb">
		      ...
		      <div class="layui-input-inline">
		      	<#if  sysUser??>
		      		...
		      		<#else>
		      		<input type="checkbox" checked="" name="enabled" id="enabled" lay-skin="switch" lay-filter="enabled" lay-text="是|否"   />
		      	</#if>
		      </div>
		    </div>
...
layui.use(['element', 'table', 'layer', 'form'], function(){
  ...
  $(".g-form-option .u-submit").click(function() {
	  ...
	  $.post(ctx + "/user/account/sysUser/" + ucode, data).then(function(resp){
		  if(resp.errcode === '0') {
