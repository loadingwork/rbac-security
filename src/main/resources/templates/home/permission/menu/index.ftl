		        	...
		        	<div class="layui-form">
		        		...
		        		<div class="layui-form-item">
					    	...
					    	<div class="layui-input-block">
					      		<input type="text" name="pcode"  id="pcode"  placeholder="父级编码"  value=""  class="layui-input"  readonly="readonly" />
					    	</div>
					    </div>
					    ...
					    <div class="layui-form-item">
					    	...
					    	<div class="layui-input-block">
					      		<input type="text" name="name"  id="name"   placeholder="菜单名称"  value=""  class="layui-input" />
					    	</div>
					    </div>
					    
					    <div class="layui-form-item">
					    	<label class="layui-form-label">请求的URI</label>
					    	<div class="layui-input-block">
					      		<input type="text" name="requestUri" id="requestUri"  value=""   placeholder="请求的URI"  class="layui-input" />
					    	</div>
					    </div>
					    ...
					    <div class="layui-form-item">
					    	...
					    	<div class="layui-input-block">
					      		<input type="text"  name="iconSrc"  id="iconSrc" value=""  class="layui-input"  />
					    	</div>
					    </div>
					    <div class="layui-form-item">
					    ...
					    <div class="layui-form-item">
					    	...
					    	<div class="layui-input-block">
					      		<input type="checkbox" checked="" name="open"  id="open" lay-skin="switch" lay-filter="open" lay-text="启用|禁用" />
					    	</div>
					    </div>
					    <div class="layui-form-item">
					    	<label class="layui-form-label">备注</label>
					    	<div class="layui-input-block">
					      		<textarea name="remarks"  name="remarks" id="remarks" class="layui-textarea" ></textarea>
					    	</div>
					    </div>
