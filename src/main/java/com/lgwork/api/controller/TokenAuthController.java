...
public class TokenAuthController {
	...
	@ApiOperation(value = "用户与密码登录", notes="用户与密码登录获取token", 
			responseReference="com.lgwork.base.result.BaseResult<LoginSuccessDTO>", httpMethod="POST")
	@ApiResponses({
		@ApiResponse(code=200, message = "成功", reference="com.lgwork.base.result.BaseResult<LoginSuccessDTO>")
	})
	@PostMapping("/login")
