...
import com.iveiv.rbac.sys.dao.SysErrorLogDAO;
import com.iveiv.rbac.util.ClientIpUtil;
...
public class SysLogAop {
	 ...
	 *  注解切点
	 */
	@Pointcut("within(@org.springframework.stereotype.Service *) || @annotation(com.iveiv.rbac.base.annotation.SysLogPoint)")
	 ...
	 *     登录
	 */
	@Pointcut("execution(* com.iveiv.rbac.**.login*(..))")
	 ...
	 *   增加
	 */
	@Pointcut("execution(* com.iveiv.rbac.**.service.save*(..)) || execution(* com.iveiv.rbac.**.service.create*(..))")
	 ...
	 *   修改
	 */
	@Pointcut("execution(* com.iveiv.rbac.**.service.update*(..)) || execution(* com.iveiv.rbac.**.service.modify*(..))")
	 ...
	 *  删除
	 */
	@Pointcut("execution(* com.iveiv.rbac.**.service.delete*(..)) || execution(* com.iveiv.rbac.**.service.remove*(..))")
	 ...
	 * 获取单个
	 */
	@Pointcut("execution(* com.iveiv.rbac.**.service.get*(..))")
	public void getCall() {
	}
	 ...
	 * 获取列表
	 */
	@Pointcut("execution(* com.iveiv.rbac.**.service.list*(..)) "
			+ " || execution(* com.iveiv.rbac.**.service.page*(..))  ")
	 ...
	 *   业务逻辑处理
	 */
	@Pointcut("execution(* com.iveiv.rbac.**.service.handle*(..))")
	 ...
	 *   导入
	 */
	@Pointcut("execution(* com.iveiv.rbac.**.service.import*(..))")
	 ...
	 *  导出
	 */
	@Pointcut("execution(* com.iveiv.rbac.**.service.export*(..))")
	 ...
	 * 上传
	 */
	@Pointcut("execution(* com.iveiv.rbac.**.service.upload*(..))")
	 ...
	 * 下载
	 */
	@Pointcut("execution(* com.iveiv.rbac.**.service.download*(..))")
